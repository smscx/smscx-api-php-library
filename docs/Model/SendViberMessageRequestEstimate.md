...
**custom_fields** | [**\Smscx\Client\Model\CustomFields**](CustomFields.md) |  | [optional]
...
**dlr_callback_url** | **string** | A valid URL to receive the delivery report update for the sent Viber message. If this parameter is set, it will overwrite the setting from [Admin Dashboard &gt; HTTP API &gt; Oauth2 &gt; Application settings](#) | [optional]
