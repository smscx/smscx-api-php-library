...
class OauthApi
{
     ...
     * Get access token
     *
     * @param  string $scope A list of space-delimited, case-sensitive strings. If left empty or ommited, the issued access token will be granted with all scopes (full privileges) (optional)
     *
     * @throws \Smscx\Client\Exception\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Smscx\Client\Model\OauthTokenResponse|\Smscx\Client\Model\Model400InvalidClient|\Smscx\Client\Model\Model403InsufficientScope|\Smscx\Client\Model\Model405MethodNotAllowed|\Smscx\Client\Model\Model429TooManyRequests|\Smscx\Client\Model\Model500ServerError
     */
    public function getAccessToken($scope = null)
    {
        list($response) = $this->getAccessTokenWithHttpInfo($scope);
        return $response;
    }
    ...
    public function getAccessTokenWithHttpInfo($scope = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Smscx\Client\Model\OauthTokenResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Smscx\Client\Model\OauthTokenResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Smscx\Client\Model\OauthTokenResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Smscx\Client\Model\Model400InvalidClient' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Smscx\Client\Model\Model400InvalidClient' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Smscx\Client\Model\Model400InvalidClient', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Smscx\Client\Model\OauthTokenResponse';
            ...
            switch ($e->getCode()) {
                case 400:             
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Smscx\Client\Model\Model400InvalidClient',
     ...
     */
    public function getAccessTokenAsync($scope = null)
    {
        return $this->getAccessTokenAsyncWithHttpInfo($scope)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccessTokenAsyncWithHttpInfo($scope = null)
    {
        $returnType = '\Smscx\Client\Model\OauthTokenResponse';
        $request = $this->getAccessTokenRequest($scope);
     ...
     */
    public function getAccessTokenRequest($scope = null)
    {
        ...
        // form params
        $formParams['grant_type'] = ObjectSerializer::toFormValue('client_credentials');
        ...
        if (!empty($this->config->getApplicationId()) || !(empty($this->config->getApplicationSecret()))) {
            $headers['Authorization'] = 'Basic ' . base64_encode($this->config->getApplicationId() . ":" . $this->config->getApplicationSecret());
        }
