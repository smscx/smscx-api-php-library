 ...
 */
class InfoGroups implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'InfoGroups';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Identifier of the group
     *
     * @return self
     */
     ...
     *
     * @param int $total_phone_numbers Total phone numbers in group
     *
     * @return self
     */
     ...
     * Sets total_cost
     *
     * @param float $total_cost Total cost of sending one message to the group
     *
     * @return self
     */
