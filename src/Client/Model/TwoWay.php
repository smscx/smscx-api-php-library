...
/**
 * TwoWay Class Doc Comment
 *
 * @category Class
 * @description If this originator is activated for two-way messaging, this object will contain details about country, type of two-way number, subscription expiry date. It will be empty object otherwise
 * @package  Smscx
 * @author   SMS Connexion
 * @link     https://sms.cx
 * @implements \ArrayAccess<string, mixed>
 */
class TwoWay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'TwoWay';
    ...
    public const TYPE_VLN = 'VLN';
    public const TYPE_SHORT_CODE = 'SHORT_CODE';
    public const TYPE__10_DLC = '10DLC';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of number to send and receive SMS: VLN (Virtual Local Number), Short code, 10DLC (10 Digits Long Code)
     *
     * @return self
     */
     ...
     * Sets country_iso
     *
     * @param string $country_iso Two-letter country code (ISO-3166 alpha 2) of the destination where two-way messaging will be used
     *
     * @return self
     */
    public function setCountryIso($country_iso)
    {
        if ((mb_strlen($country_iso) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_iso when calling TwoWay., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_iso) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_iso when calling TwoWay., must be bigger than or equal to 2.');
        }
     ...
     * Sets expire_date
     *
     * @param \DateTime $expire_date The date in UTC when the two-way messaging number subscription will expire
     *
     * @return self
     */
