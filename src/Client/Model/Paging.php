...
class Paging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'Paging';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('size', $data ?? [], 500);
    }
    ...
    */
     ...
     * Sets next
     *
     * @param string $next Cursor for next page
     *
     * @return self
     */
    public function setNext($next)
    {
        ...
        if (is_null($next)) {
            array_push($this->clientNullablesSetToNull, 'next');
        } else {
     ...
     * Sets previous
     *
     * @param string $previous Cursor for previous page
     *
     * @return self
     */
    public function setPrevious($previous)
    {
        ...
        if (is_null($previous)) {
            array_push($this->clientNullablesSetToNull, 'previous');
        } else {
            $nullablesSetToNull = $this->getClientNullablesSetToNull();
     ...
     * Sets size
     *
     * @param int $size Size (limit) of the data returned
     *
     * @return self
     */
    public function setSize($size)
    {
        ...
        if (($size > 500)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Paging., must be smaller than or equal to 500.');
        }
        if (($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Paging., must be bigger than or equal to 0.');
        }
