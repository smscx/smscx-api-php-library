...
/**
 * VerifyPinRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class VerifyPinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'VerifyPinRequest';
    ...
    */
     ...
     * Sets pin
     *
     * @param string $pin The PIN code received on the mobile number
     *
     * @return self
     */
