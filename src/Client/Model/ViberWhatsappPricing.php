...
/**
 * ViberWhatsappPricing Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ViberWhatsappPricing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ViberWhatsappPricing';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['promotional'] === null) {
            $invalidProperties[] = "'promotional' can't be null";
        }
     ...
     * Sets transactional
     *
     * @param float $transactional Price for a transactional message (only text)
     *
     * @return self
     */
     ...
     * Sets promotional
     *
     * @param float $promotional Price for a promotional message (text and rich media)
     *
     * @return self
     */
