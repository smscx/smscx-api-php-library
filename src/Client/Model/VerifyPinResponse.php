...
/**
 * VerifyPinResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class VerifyPinResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'VerifyPinResponse';
    ...
    {
        $this->setIfExists('status', $data ?? [], 'VERIFIED');
    }
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Will have value `VERIFIED` if the pin entered is correct
     *
     * @return self
     */
