...
/**
 * ReportSingleResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ReportSingleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReportSingleResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataReportCampaign $data data
     *
     * @return self
     */
