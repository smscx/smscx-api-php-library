...
/**
 * BulkLookupCampaignsResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class BulkLookupCampaignsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'BulkLookupCampaignsResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataLookupCampaigns[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataLookupCampaigns[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataLookupCampaigns[] $data 
     *
     * @return self
     */
