...
/**
 * NewGroupRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class NewGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'NewGroupRequest';
    ...
    */
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NewGroupRequest., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NewGroupRequest., must be bigger than or equal to 3.');
        }
