...
/**
 * AddContactsToGroupWithFieldsRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class AddContactsToGroupWithFieldsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'AddContactsToGroupWithFieldsRequest';
    ...
    protected static $clientTypes = [
        'phone_numbers' => '\Smscx\Client\Model\GroupAdd[]',
        'allow_invalid' => 'bool'
    ];
    ...
    */
     ...
     * Gets phone_numbers
     *
     * @return \Smscx\Client\Model\GroupAdd[]
     */
     ...
     * Sets phone_numbers
     *
     * @param \Smscx\Client\Model\GroupAdd[] $phone_numbers An array of objects if you want to add custom fields data to your contacts
     *
     * @return self
     */
     ...
     * Sets allow_invalid
     *
     * @param bool|null $allow_invalid Set value `true` to not throw an error if invalid numbers are detected
     *
     * @return self
     */
