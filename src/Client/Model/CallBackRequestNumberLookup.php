...
/**
 * CallBackRequestNumberLookup Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class CallBackRequestNumberLookup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CallBackRequestNumberLookup';
    ...
    protected static $clientTypes = [
        ...
        'data' => '\Smscx\Client\Model\DataNumberLookupWebhook[]'
    ];
    ...
    public const EVENT_OTP_UPDATE = 'otp_update';
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataNumberLookupWebhook[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataNumberLookupWebhook[] $data Event data, grouped in multiple objects (up to 200 in a request)
     *
     * @return self
     */
