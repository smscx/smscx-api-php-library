...
/**
 * ShortlinksListResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ShortlinksListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ShortlinksListResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataShortlinkList[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataShortlinkList[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataShortlinkList[] $data 
     *
     * @return self
     */
