...
/**
 * RentedNumbersResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class RentedNumbersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'RentedNumbersResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataRentedNumbers[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataRentedNumbers[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataRentedNumbers[] $data List of rented phone numbers
     *
     * @return self
     */
