...
/**
 * ReportsSummaryTrafficResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ReportsSummaryTrafficResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReportsSummaryTrafficResponse';
    ...
    protected static $clientTypes = [
        'data' => 'array<string,\Smscx\Client\Model\ReportsSummaryTrafficResponseDataValue>'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return array<string,\Smscx\Client\Model\ReportsSummaryTrafficResponseDataValue>
     */
     ...
     * Sets data
     *
     * @param array<string,\Smscx\Client\Model\ReportsSummaryTrafficResponseDataValue> $data data
     *
     * @return self
     */
