...
class Attachments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'Attachments';
    ...
    protected static $attributeMap = [
        'attachments_callback' => 'attachmentsCallback'
    ];
    ...
    protected static $setters = [
        'attachments_callback' => 'setAttachmentsCallback'
    ];
    ...
    protected static $getters = [
        'attachments_callback' => 'getAttachmentsCallback'
    ];
    ...
    {
        $this->setIfExists('attachments_callback', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['attachments_callback'] === null) {
            $invalidProperties[] = "'attachments_callback' can't be null";
        }
    ...
    /**
     * Gets attachments_callback
     *
     * @return string
     */
    public function getAttachmentsCallback()
    {
        return $this->container['attachments_callback'];
    }

    /**
     * Sets attachments_callback
     *
     * @param string $attachments_callback attachments_callback
     *
     * @return self
     */
    public function setAttachmentsCallback($attachments_callback)
    {

        if (is_null($attachments_callback)) {
            array_push($this->clientNullablesSetToNull, 'attachments_callback');
        } else {
            $nullablesSetToNull = $this->getClientNullablesSetToNull();
            $index = array_search('attachments_callback', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['attachments_callback'] = $attachments_callback;
