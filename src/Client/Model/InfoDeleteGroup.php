...
/**
 * InfoDeleteGroup Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class InfoDeleteGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'InfoDeleteGroup';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Identifier of the deleted group
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name of the deleted group
     *
     * @return self
     */
     ...
     *
     * @param int $total_phone_numbers Total phone numbers in the deleted group
     *
     * @return self
     */
