...
/**
 * NetworkOperator Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class NetworkOperator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'NetworkOperator';
    ...
    protected static $clientTypes = [
        'operator_name' => 'array<string,float>'
    ];
    ...
    */
     ...
     * Sets operator_name
     *
     * @param array<string,float> $operator_name The name of the network operator
     *
     * @return self
     */
