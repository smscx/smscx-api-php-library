...
/**
 * TemplatesNewRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class TemplatesNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'TemplatesNewRequest';
    ...
    */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TemplatesNewRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($name) && (mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TemplatesNewRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets text
     *
     * @param string $text Template text. For channels `viber` and `whatsapp` the max. length is 1000 characters
     *
     * @return self
     */
