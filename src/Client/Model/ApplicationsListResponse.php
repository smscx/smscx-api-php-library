...
/**
 * ApplicationsListResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ApplicationsListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ApplicationsListResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataApplicationsList[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataApplicationsList[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataApplicationsList[] $data 
     *
     * @return self
     */
