...
/**
 * CallBackRequestNewOptout Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class CallBackRequestNewOptout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CallBackRequestNewOptout';
    ...
    protected static $clientTypes = [
        ...
        'data' => '\Smscx\Client\Model\DataNewOptout[]'
    ];
    ...
    public const EVENT_NEW_OPTOUT = 'new_optout';
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataNewOptout[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataNewOptout[] $data Event data, grouped in multiple objects (up to 200 in a request)
     *
     * @return self
     */
