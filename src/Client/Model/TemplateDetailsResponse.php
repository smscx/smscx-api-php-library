...
class TemplateDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'TemplateDetailsResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataTemplate'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataTemplate
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataTemplate $data data
     *
     * @return self
     */
