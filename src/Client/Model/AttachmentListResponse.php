...
class AttachmentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'AttachmentListResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataAttachment[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataAttachment[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataAttachment[] $data 
     *
     * @return self
     */
