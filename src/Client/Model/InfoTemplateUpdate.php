...
/**
 * InfoTemplateUpdate Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class InfoTemplateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'InfoTemplateUpdate';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Identifier of the updated template
     *
     * @return self
     */
