...
class TemplatesUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'TemplatesUpdateRequest';
    ...
    protected static $clientTypes = [
        ...
        'text' => 'string',
        'channel' => 'string',
        'rich_media' => '\Smscx\Client\Model\RichMedia'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the template. If this parameter is omitted the name of the template will be set by the API eg. \"Template 2021-06-11 21:00:00\"
     *
     * @return self
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TemplatesUpdateRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($name) && (mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TemplatesUpdateRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets text
     *
     * @param string|null $text Template text. For channels `viber` and `whatsapp` the max. length is 1000 characters
     *
     * @return self
     */
     ...
     * Sets channel
     *
     * @param string|null $channel The channel for wich the template is saved
     *
     * @return self
     */
     ...
     * Gets rich_media
     *
     * @return \Smscx\Client\Model\RichMedia|null
     */
     ...
     * Sets rich_media
     *
     * @param \Smscx\Client\Model\RichMedia|null $rich_media rich_media
     *
     * @return self
     */
