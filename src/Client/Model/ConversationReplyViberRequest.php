...
/**
 * ConversationReplyViberRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ConversationReplyViberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ConversationReplyViberRequest';
    ...
    */
    ...
    public function setText($text)
    {
        if ((mb_strlen($text) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling ConversationReplyViberRequest., must be smaller than or equal to 1000.');
        }
