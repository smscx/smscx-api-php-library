...
class GroupsList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'GroupsList';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataGroups[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataGroups[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataGroups[] $data 
     *
     * @return self
     */
