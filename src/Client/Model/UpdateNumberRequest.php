...
/**
 * UpdateNumberRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class UpdateNumberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'UpdateNumberRequest';
    ...
    */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number in international E.164 format to replace the current phone number.
     *
     * @return self
     */
