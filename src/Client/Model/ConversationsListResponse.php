...
/**
 * ConversationsListResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ConversationsListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ConversationsListResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataConversations[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataConversations[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataConversations[] $data 
     *
     * @return self
     */
