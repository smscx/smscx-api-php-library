...
/**
 * OptoutsNewRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class OptoutsNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'OptoutsNewRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('allow_invalid', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['allow_invalid'] === null) {
            $invalidProperties[] = "'allow_invalid' can't be null";
        }
     ...
     * Sets allow_invalid
     *
     * @param bool $allow_invalid allow_invalid
     *
     * @return self
     */
