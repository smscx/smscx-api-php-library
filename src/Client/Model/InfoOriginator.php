...
/**
 * InfoOriginator Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class InfoOriginator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'InfoOriginator';
    ...
    */
     ...
     * Sets originator
     *
     * @param string $originator Originator submitted for approval
     *
     * @return self
     */
    public function setOriginator($originator)
    {
        if ((mb_strlen($originator) > 15)) {
            throw new \InvalidArgumentException('invalid length for $originator when calling InfoOriginator., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($originator) < 3)) {
            throw new \InvalidArgumentException('invalid length for $originator when calling InfoOriginator., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $originator))) {
            throw new \InvalidArgumentException("invalid value for \$originator when calling InfoOriginator., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
