...
/**
 * ReportsSummaryCountryResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ReportsSummaryCountryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReportsSummaryCountryResponse';
    ...
    protected static $clientTypes = [
        'data' => 'array<string,\Smscx\Client\Model\ReportsSummaryCountryResponseDataValue>'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return array<string,\Smscx\Client\Model\ReportsSummaryCountryResponseDataValue>
     */
     ...
     * Sets data
     *
     * @param array<string,\Smscx\Client\Model\ReportsSummaryCountryResponseDataValue> $data data
     *
     * @return self
     */
