...
/**
 * CallBackRequestShortlinkHit Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class CallBackRequestShortlinkHit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CallBackRequestShortlinkHit';
    ...
    protected static $clientTypes = [
        ...
        'data' => '\Smscx\Client\Model\DataShortlinkHit[]'
    ];
    ...
    public const EVENT_HIT = 'shortlink_hit';
    public const EVENT_HIT_UPDATE = 'shortlink_hit_update';
    ...
    */
     ...
     * Sets event
     *
     * @param CallbackEventTypes $event event
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataShortlinkHit[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataShortlinkHit[] $data Event type data, grouped in multiple objects (up to 200 in a request)
     *
     * @return self
     */
