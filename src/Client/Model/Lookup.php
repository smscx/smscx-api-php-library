...
class Lookup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'Lookup';
    ...
    protected static $attributeMap = [
        'lookup_callback' => 'lookupCallback'
    ];
    ...
    protected static $setters = [
        'lookup_callback' => 'setLookupCallback'
    ];
    ...
    protected static $getters = [
        'lookup_callback' => 'getLookupCallback'
    ];
    ...
    {
        $this->setIfExists('lookup_callback', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lookup_callback'] === null) {
            $invalidProperties[] = "'lookup_callback' can't be null";
        }
    ...
    /**
     * Gets lookup_callback
     *
     * @return string
     */
    public function getLookupCallback()
    {
        return $this->container['lookup_callback'];
    }

    /**
     * Sets lookup_callback
     *
     * @param string $lookup_callback lookup_callback
     *
     * @return self
     */
    public function setLookupCallback($lookup_callback)
    {

        if (is_null($lookup_callback)) {
            array_push($this->clientNullablesSetToNull, 'lookup_callback');
        } else {
            $nullablesSetToNull = $this->getClientNullablesSetToNull();
            $index = array_search('lookup_callback', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['lookup_callback'] = $lookup_callback;
