...
/**
 * CallBackRequestOtpUpdate Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class CallBackRequestOtpUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CallBackRequestOtpUpdate';
    ...
    protected static $clientTypes = [
        ...
        'data' => '\Smscx\Client\Model\DataOtp[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataOtp[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataOtp[] $data Event data, grouped in multiple objects (up to 200 in a request)
     *
     * @return self
     */
