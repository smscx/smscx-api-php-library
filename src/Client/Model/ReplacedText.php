 ...
 */
class ReplacedText implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReplacedText';
    ...
    protected static $clientTypes = [
        ...
        'parts' => 'int',
        'encoding' => 'string',
        'characters' => '\Smscx\Client\Model\CharactersReplaced'
    ];
    ...
    */
     ...
     * Sets text
     *
     * @param string $text Text after the conversion of Unicode characters to GSM alphabet
     *
     * @return self
     */
     ...
     * Sets length
     *
     * @param int $length Length of the converted text
     *
     * @return self
     */
     ...
     * Sets encoding
     *
     * @param string $encoding Encoding of the converted text
     *
     * @return self
     */
     ...
     * Gets characters
     *
     * @return \Smscx\Client\Model\CharactersReplaced
     */
     ...
     * Sets characters
     *
     * @param \Smscx\Client\Model\CharactersReplaced $characters characters
     *
     * @return self
     */
