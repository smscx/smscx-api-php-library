...
/**
 * ApplicationSettingsResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ApplicationSettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ApplicationSettingsResponse';
    ...
    protected static $clientTypes = [
        ...
        'settings' => '\Smscx\Client\Model\Settings'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('token_expiration', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['token_expiration'] === null) {
            $invalidProperties[] = "'token_expiration' can't be null";
        }
     ...
     *
     * @param string $token_expiration token_expiration
     *
     * @return self
     */
    public function setTokenExpiration($token_expiration)
    {
        ...
        if (is_null($token_expiration)) {
            throw new \InvalidArgumentException('non-nullable token_expiration cannot be null');
        }
     ...
     * Gets settings
     *
     * @return \Smscx\Client\Model\Settings
     */
     ...
     * Sets settings
     *
     * @param \Smscx\Client\Model\Settings $settings settings
     *
     * @return self
     */
