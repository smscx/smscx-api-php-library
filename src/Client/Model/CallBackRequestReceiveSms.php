...
/**
 * CallBackRequestReceiveSms Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class CallBackRequestReceiveSms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CallBackRequestReceiveSms';
    ...
    protected static $clientTypes = [
        ...
        'data' => '\Smscx\Client\Model\DataReceiveSms[]'
    ];
    ...
    public const EVENT_RECEIVE_SMS = 'receive_sms';
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataReceiveSms[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataReceiveSms[] $data Event data, grouped in multiple objects (up to 200 in a request)
     *
     * @return self
     */
