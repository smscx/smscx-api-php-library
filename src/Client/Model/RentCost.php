 ...
 */
class RentCost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'RentCost';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['days']) && !in_array($this->container['days'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'days', must be one of '%s'",
                $this->container['days'],
     ...
     * Sets days
     *
     * @param int $days Rent period (in days)
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getDaysAllowableValues();
        if (!in_array($days, $allowedValues, true)) {
     ...
     * Sets cost
     *
     * @param float $cost Cost to rent the number for 1, 7 or 30 days
     *
     * @return self
     */
