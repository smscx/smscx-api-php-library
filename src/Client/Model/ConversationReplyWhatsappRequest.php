...
/**
 * ConversationReplyWhatsappRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ConversationReplyWhatsappRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ConversationReplyWhatsappRequest';
    ...
    */
     ...
     * Sets text
     *
     * @param string $text The reply text message
     *
     * @return self
     */
    public function setText($text)
    {
        if ((mb_strlen($text) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling ConversationReplyWhatsappRequest., must be smaller than or equal to 1000.');
        }
