...
/**
 * NumberValidateResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class NumberValidateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'NumberValidateResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataNumberValidate'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataNumberValidate
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataNumberValidate $data data
     *
     * @return self
     */
