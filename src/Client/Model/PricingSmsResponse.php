...
/**
 * PricingSmsResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class PricingSmsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'PricingSmsResponse';
    ...
    protected static $clientTypes = [
        'country_code' => 'array<string,\Smscx\Client\Model\NetworkOperator>'
    ];
    ...
    */
     ...
     * Gets country_code
     *
     * @return array<string,\Smscx\Client\Model\NetworkOperator>
     */
     ...
     * Sets country_code
     *
     * @param array<string,\Smscx\Client\Model\NetworkOperator> $country_code Every **countryCode** object contains objects of network operators and their coresponding pricing
     *
     * @return self
     */
