...
class CustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CustomFields';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['custom_field_name'] === null) {
            $invalidProperties[] = "'custom_field_name' can't be null";
        }
     ...
     *
     * @param array<string,string> $custom_field_name The name of the custom field
     *
     * @return self
     */
