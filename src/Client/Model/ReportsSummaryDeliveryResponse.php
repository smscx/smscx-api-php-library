...
/**
 * ReportsSummaryDeliveryResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ReportsSummaryDeliveryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReportsSummaryDeliveryResponse';
    ...
    protected static $clientTypes = [
        'data' => 'array<string,\Smscx\Client\Model\ReportsSummaryDeliveryResponseDataValue>'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return array<string,\Smscx\Client\Model\ReportsSummaryDeliveryResponseDataValue>
     */
     ...
     * Sets data
     *
     * @param array<string,\Smscx\Client\Model\ReportsSummaryDeliveryResponseDataValue> $data data
     *
     * @return self
     */
