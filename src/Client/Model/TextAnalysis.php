...
/**
 * TextAnalysis Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class TextAnalysis implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'TextAnalysis';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('unicode', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unicode'] === null) {
            $invalidProperties[] = "'unicode' can't be null";
        }
     ...
     * Sets length
     *
     * @param int $length Total character length of the message
     *
     * @return self
     */
    ...
    {
        return $this->container['unicode'];
    }

    /**
     * Sets unicode
     *
     * @param bool $unicode Will be `true` if the message contains characters that are not in the [GSM-7 character set](https://en.wikipedia.org/wiki/GSM_03.38)
     *
     * @return self
     */
    public function setUnicode($unicode)
    {
        ...
        if (is_null($unicode)) {
            throw new \InvalidArgumentException('non-nullable unicode cannot be null');
        }

        $this->container['unicode'] = $unicode;
    ...
    public function setParts($parts)
    {
        ...
        if (($parts < 1)) {
            throw new \InvalidArgumentException('invalid value for $parts when calling TextAnalysis., must be bigger than or equal to 1.');
        }
