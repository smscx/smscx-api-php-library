...
/**
 * ReportsSummaryChannelResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ReportsSummaryChannelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReportsSummaryChannelResponse';
    ...
    protected static $clientTypes = [
        'data' => 'array<string,\Smscx\Client\Model\ReportsSummaryChannelResponseDataValue>'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return array<string,\Smscx\Client\Model\ReportsSummaryChannelResponseDataValue>
     */
     ...
     * Sets data
     *
     * @param array<string,\Smscx\Client\Model\ReportsSummaryChannelResponseDataValue> $data data
     *
     * @return self
     */
