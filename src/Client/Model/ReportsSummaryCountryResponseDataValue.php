...
/**
 * ReportsSummaryCountryResponseDataValue Class Doc Comment
 *
 * @category Class
 * @description Two-letter country ISO of the country destination
 * @package  Smscx
 * @author   SMS Connexion
 * @link     https://sms.cx
 * @implements \ArrayAccess<string, mixed>
 */
class ReportsSummaryCountryResponseDataValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReportsSummaryCountryResponse_data_value';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cost_parts', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cost_parts'] === null) {
            $invalidProperties[] = "'cost_parts' can't be null";
        }
     ...
     * Sets phone_numbers
     *
     * @param int $phone_numbers phone_numbers
     *
     * @return self
     */
    ...
    {
        return $this->container['cost_parts'];
    }

    /**
     * Sets cost_parts
     *
     * @param float $cost_parts cost_parts
     *
     * @return self
     */
    public function setCostParts($cost_parts)
    {
        ...
        if (is_null($cost_parts)) {
            throw new \InvalidArgumentException('non-nullable cost_parts cannot be null');
        }

        $this->container['cost_parts'] = $cost_parts;
