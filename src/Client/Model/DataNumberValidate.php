...
/**
 * DataNumberValidate Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class DataNumberValidate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'DataNumberValidate';
    ...
    */
     ...
     * Sets timezone
     *
     * @param string $timezone Timezone of the phone number based on the country iso
     *
     * @return self
     */
