...
/**
 * CallBackRequestDlrUpdate Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class CallBackRequestDlrUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CallBackRequestDlrUpdate';
    ...
    protected static $clientTypes = [
        ...
        'data' => '\Smscx\Client\Model\DataDlrUpdate[]'
    ];
    ...
    public const EVENT_DLR_UPDATE = 'dlr_update';
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataDlrUpdate[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataDlrUpdate[] $data Event data, grouped in multiple objects (up to 200 in a request)
     *
     * @return self
     */
