...
/**
 * InfoShortlinkDetail Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class InfoShortlinkDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'InfoShortlinkDetail';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Identifier of the shortlink
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name of the shortlink
     *
     * @return self
     */
     ...
     * Sets short_url
     *
     * @param string $short_url Short link that redirects to the long URL
     *
     * @return self
     */
     ...
     * Sets original_url
     *
     * @param string $original_url Original long URL that was transformed to a short link
     *
     * @return self
     */
     ...
     * Sets hits
     *
     * @param int $hits Number of hits to the short link
     *
     * @return self
     */
