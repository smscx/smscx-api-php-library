...
/**
 * GroupAddCustomFields Class Doc Comment
 *
 * @category Class
 * @description The &#x60;customFields&#x60; parameter is an object with key-value pairs, where the key is the name of the custom field. Eg. you can add a customField &#x60;height&#x60;. You can add up to 20 custom fields. The data stored in the custom fields can be used in the text of the message by using the placeholder &#x60;{{&lt;KEY&gt;}}&#x60;
 * @package  Smscx
 * @author   SMS Connexion
 * @link     https://sms.cx
 * @implements \ArrayAccess<string, mixed>
 */
class GroupAddCustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'GroupAdd_customFields';
    ...
    protected static $clientTypes = [
        'custom_field_name' => 'array<string,string>'
    ];
    ...
    {
        $this->setIfExists('custom_field_name', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param array<string,string>|null $custom_field_name The name of the custom field
     *
     * @return self
     */
    public function setCustomFieldName($custom_field_name)
    {
        ...
        if (is_null($custom_field_name)) {
            throw new \InvalidArgumentException('non-nullable custom_field_name cannot be null');
        }
