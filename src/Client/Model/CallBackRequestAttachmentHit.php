...
/**
 * CallBackRequestAttachmentHit Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class CallBackRequestAttachmentHit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'CallBackRequestAttachmentHit';
    ...
    public const EVENT_HIT = 'attachment_hit';
    public const EVENT_HIT_UPDATE = 'attachment_hit_update';
