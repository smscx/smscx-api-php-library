...
/**
 * InfoNewGroup Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class InfoNewGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'InfoNewGroup';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The id of the new group created
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InfoNewGroup., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InfoNewGroup., must be bigger than or equal to 3.');
        }
