...
/**
 * ShortlinkUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ShortlinkUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ShortlinkUpdateRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name New name for the shortlink
     *
     * @return self
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShortlinkUpdateRequest., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShortlinkUpdateRequest., must be bigger than or equal to 3.');
        }
