...
/**
 * NumberLookupResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class NumberLookupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'NumberLookupResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataNumberLookup $data data
     *
     * @return self
     */
