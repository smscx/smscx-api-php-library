...
/**
 * RentNumbersResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class RentNumbersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'RentNumbersResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataAvailableNumbersRent[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataAvailableNumbersRent[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataAvailableNumbersRent[] $data List of available phone numbers for rent
     *
     * @return self
     */
