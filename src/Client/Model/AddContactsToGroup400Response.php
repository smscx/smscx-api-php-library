...
/**
 * AddContactsToGroup400Response Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class AddContactsToGroup400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'AddContactsToGroup_400_response';
    ...
    protected static $clientTypes = [
        'error' => '\Smscx\Client\Model\Error',
        'invalid' => 'string[]'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \Smscx\Client\Model\Error
     */
     ...
     * Sets error
     *
     * @param \Smscx\Client\Model\Error $error error
     *
     * @return self
     */
     ...
     * Sets invalid
     *
     * @param string[] $invalid Array of invalid phone numbers
     *
     * @return self
     */
