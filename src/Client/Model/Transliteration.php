...
/**
 * Transliteration Class Doc Comment
 *
 * @category Class
 ...
 */
class Transliteration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'Transliteration';
    ...
    */
     ...
     * Sets alphabet
     *
     * @param string $alphabet Set the alphabet for which the transliteration will be done. If `NON_GSM` is set then all characters that are not in the GSM-7 alphabet will be mapped to a similar character in the GSM alphabet. Characters that have no equivalent  in the GSM alphabet will be replaced by a question mark `?`
     *
     * @return self
     */
     ...
     * Sets remove_emojis
     *
     * @param bool|null $remove_emojis This is optional and defaults to `false`. If set to `true` all Emojis found in the text will be removed
     *
     * @return self
     */
