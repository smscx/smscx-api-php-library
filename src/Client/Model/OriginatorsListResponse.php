...
/**
 * OriginatorsListResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class OriginatorsListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'OriginatorsListResponse';
    ...
    protected static $clientTypes = [
        'data' => '\Smscx\Client\Model\DataOriginatorsList[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataOriginatorsList[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataOriginatorsList[] $data 
     *
     * @return self
     */
