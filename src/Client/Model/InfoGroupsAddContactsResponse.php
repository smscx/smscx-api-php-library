...
/**
 * InfoGroupsAddContactsResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class InfoGroupsAddContactsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'InfoGroupsAddContactsResponse';
    ...
    */
     ...
     * Sets total_cost
     *
     * @param float $total_cost Total cost to send a message to the phone numbers added to group
     *
     * @return self
     */
     ...
     * Sets total_valid
     *
     * @param int $total_valid Total valid phone numbers added to the group
     *
     * @return self
     */
     ...
     *
     * @param int $total_duplicates Total duplicates phone numbers found
     *
     * @return self
     */
     ...
     *
     * @param int $total_phone_numbers Total submitted phone numbers to be added to the group
     *
     * @return self
     */
