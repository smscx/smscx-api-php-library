...
/**
 * ReportsSummarySourceResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ReportsSummarySourceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ReportsSummarySourceResponse';
    ...
    protected static $clientTypes = [
        'data' => 'array<string,\Smscx\Client\Model\ReportsSummarySourceResponseDataValue>'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return array<string,\Smscx\Client\Model\ReportsSummarySourceResponseDataValue>
     */
     ...
     * Sets data
     *
     * @param array<string,\Smscx\Client\Model\ReportsSummarySourceResponseDataValue> $data data
     *
     * @return self
     */
