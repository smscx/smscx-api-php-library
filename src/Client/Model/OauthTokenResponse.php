...
class OauthTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'OauthTokenResponse';
    ...
    */
     ...
     * Sets expires_in
     *
     * @param int $expires_in Expiration time of token in seconds. This value is set in the Admin Dashboard and can be: 1 day, 1 week, never
     *
     * @return self
     */
