...
/**
 * NumbersLookupResponse Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class NumbersLookupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'NumbersLookupResponse';
    ...
    protected static $clientTypes = [
        ...
        'data' => '\Smscx\Client\Model\DataNumbersLookup[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Smscx\Client\Model\DataNumbersLookup[]
     */
     ...
     * Sets data
     *
     * @param \Smscx\Client\Model\DataNumbersLookup[] $data 
     *
     * @return self
     */
