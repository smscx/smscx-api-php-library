...
/**
 * OriginalNetwork Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class OriginalNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'OriginalNetwork';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the network operator
     *
     * @return self
     */
