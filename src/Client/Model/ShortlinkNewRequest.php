...
/**
 * ShortlinkNewRequest Class Doc Comment
 *
 * @category Class
 * @package  Smscx
 * @author   SMS Connexion
 ...
 */
class ShortlinkNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $clientModelName = 'ShortlinkNewRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name If this parameter is omitted the name of the shortlink will be set by the API eg. \"Short link \\#433\"
     *
     * @return self
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShortlinkNewRequest., must be smaller than or equal to 25.');
        }
        if (!is_null($name) && (mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShortlinkNewRequest., must be bigger than or equal to 3.');
        }
